...
//		Collections.sort(lista);	//compara pela ordem natural: estabelecida pelo compareTo da classe Conta
		...
		Comparator<Conta> comp = new Comparator<Conta>() {	// outra classe anonima
